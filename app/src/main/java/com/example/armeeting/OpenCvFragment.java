...
//                        new CompareSizesByArea());
                Size largest = Collections.max(
                        Arrays.asList(map.getOutputSizes(ImageFormat.JPEG)),
                        new CompareSizesByRatio(mTextureView.getHeight(), mTextureView.getWidth()));
...
//                }
    ...
    /**
     * Opens the camera specified by {@link OpenCvFragment#mCameraId}.
     */
